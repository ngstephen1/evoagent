...
| Kaggle Competition | 4 | Produce valid hidden-test predictions and compete on the private leaderboard. | Current best Run 009-lite safe public score `0.65789` |
...
Current best Kaggle submission is Run 009-lite safe:

| Field | Value |
| --- | --- |
| File | `assignment03/runs/kaggle_hybrid_retry_run009_lite_safe/submission_checked.csv` |
| Description | `Run009-lite safe filtered targeted retry` |
